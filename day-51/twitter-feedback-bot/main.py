...
class InternetSpeedTwitterBot:
    ...
    def tweet_at_provider(self):
        ...
        self.driver.get(url)
        time.sleep(5)
        login = self.driver.find_element(By.XPATH,'//*[@id="react-root"]/div/div/div[2]/main/div/div/div[1]/div/div/div[3]/div[5]/a')
        login.click()
        time.sleep(5)

        # May not need depending upon twitter login format
        twitter_name = self.driver.find_element(By.TAG_NAME, "input")
        twitter_name.send_keys("mapstyls", Keys.ENTER)
        time.sleep(5)
        ...
        password.send_keys("tweetWhizx1?", Keys.ENTER)
        time.sleep(10)
